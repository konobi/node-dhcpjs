...
tap.test('initial values - options', function(t) {
  t.plan(15);
  ...
  var opt = obj.options;
  t.equal(opt.subNetMask, '255.255.255.0', 'subnetmask option is correct');
  t.equal(opt.routers, ['172.16.10.1'], 'routers option is correct');
